...
\section{Profile}
  ...
  10+ years experience in software development and data engineering \& science,
  from engineer, manager, to coach. Passionate in software engineering, data
  engineering, and data science.

\section{Current Position}

{\bf Data Product Developer and Technical Coach, ODDS}\\
...
\begin{itemize}
  \item Data Pipelines with Apache Airflow
  \item Analytics Engineering with dbt
  \item Introducing Kafka
  \item Python \& Django for Web Application Development
